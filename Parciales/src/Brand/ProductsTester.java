...
public class ProductsTester {
    public static void main(String[] args) {
       ...
       .......... iPhone = new ..........("iPhone 13", apple, 1000, ..........);
       ...
       .......... airpods = new ..........("AirPods", apple, 500, "Dolby Atmos");
        ...
        System.out.println(airpods.getFinalPrice(..........)); // 575.0
        ...
        // Se obtiene el precio final del dispositivo con garantía básica
        System.out.println(iPhone.getFinalPrice(  3  )); // 1220.0
        ...
        // Se obtiene el precio final del accesorio con garantía premium
        System.out.println(airpods.getFinalPrice(  5  )); // 600.0
