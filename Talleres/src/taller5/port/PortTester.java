...
public class PortTester {
    public static void main(String[] args) {
        ...
        FerryPort londsdaleQuay = new TimedFerryPort("Lonsdale Quay",
        ...
        FerryPort stanleyPark = new LastInFerryPort("Stanley Park", transLink, 3, LocalTime.of(9, 0), LocalTime.of(14, 0));
