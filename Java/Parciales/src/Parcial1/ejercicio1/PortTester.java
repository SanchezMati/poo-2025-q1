...
public class PortTester {
    public static void main(String[] args) {
        ...
        Port londsdaleQuay = new TimedPort("Lonsdale Quay",
        ...
        Port stanleyPark = new OnlyUndockLastFerryPort("Stanley Park", transLink, 3, LocalTime.of(9, 0), LocalTime.of(14, 0));
