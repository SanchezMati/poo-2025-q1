...
public class ParkRideTester {
    public static void main(String[] args) {
        ...
        slots.ParkRide soarin = new slots.ParkRide("Soarin", LocalTime.of(9,0), LocalTime.of(10,0), 15);
        for(slots.ParkSlot soarinSlot : soarin) {
        ...
        slots.ParkRide tT = new slots.ParkRide("Test Track", LocalTime.of(19,30), LocalTime.of(21,0), 60);
        for(slots.ParkSlot tTSlot : tT) {
        ...
        Iterator<slots.ParkSlot> soarinIt = soarin.iterator();
        ...
        try {
            ...
            new slots.ParkRide("Spaceship Earth", LocalTime.of(9,30), LocalTime.of(7,30), 10);
        } catch (Exception ex) {
        ...
        try {
            ...
            new slots.ParkRide("Spaceship Earth", LocalTime.of(23,30), LocalTime.of(1,0), 30);
        } catch (Exception ex) {
            System.out.println(ex.getMessage()); // Close time cannot be before open time
        }
        try {
            // Se arroja un error porque la cantidad de minutos de los slots debe ser positiva
            new slots.ParkRide("Spaceship Earth", LocalTime.of(9,0), LocalTime.of(10,0), 0);
        } catch (Exception ex) {
            System.out.println(ex.getMessage()); // Slot minutes must be positive
        }
        slots.ParkRide seaBase = new ParkRide("SeaBase", LocalTime.of(9,0), LocalTime.of(9,0), 45);
        try {
